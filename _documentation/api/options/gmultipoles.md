...
-gmultipoles=<sequence> ....: define the e.m. gmultipoles
   ...
   • pole_number: Pole number (even integer >= 2): 2=dipole, 4=quadrupole, ...Default value: required
   ...
   • rotaxis: Rotation/longitudinal axis: one of X, Y, ZDefault value: required
   • strength: Field strength in Tesla (defined at 1 m reference radius for multipoles)Default value: required
