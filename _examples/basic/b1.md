...
{% assign example = site.data.examples | where: "title", "geant4 basic/b1" | first %}
...
```shell
gemc-analyzer b1_digitized.csv dose --kind csv
```

![b1 accumulated dose][b1-analyzer_dose]{:width="70%"}

[b1-analyzer_dose]: /home/assets/images/examples/b1/analyzer_dose.png
