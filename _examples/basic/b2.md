...
{% assign example = site.data.examples | where: "title", "geant4 basic/b2" | first %}
...
![b2 total energy deposited per hit][b2-analyzer_totEdep]{:width="70%"}

[b2-analyzer_totEdep]: /home/assets/images/examples/b2/analyzer_totEdep.png
...
![b2 true particle track energy][b2-analyzer_true_energy]{:width="70%"}

[b2-analyzer_true_energy]: /home/assets/images/examples/b2/analyzer_true_energy.png
...
![b2 proton polar-angle residual][b2-analyzer_delta_theta]{:width="70%"}

[b2-analyzer_delta_theta]: /home/assets/images/examples/b2/analyzer_delta_theta.png
